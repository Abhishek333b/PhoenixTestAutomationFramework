...
public class CreateJobPayload {
	...
	public CreateJobPayload(int mst_service_location_id, int mst_platform_id, int mst_warrenty_status_id,
			int mst_oem_id, Customer customer, CustomerAddress cucustomer_address, CustomerProduct customer_product,
			Problems[] problems) {
		super();
	...
	public CustomerAddress getCucustomer_address() {
		return customer_address;
	}
	public void setCucustomer_address(CustomerAddress cucustomer_address) {
		this.customer_address = cucustomer_address;
	}
	...
	public String toString() {
		return "CreateJobPayload [mst_service_location_id=" + mst_service_location_id + ", mst_platform_id="
				...
				+ ", customer=" + customer + ", cucustomer_address=" + customer_address + ", customer_product="
