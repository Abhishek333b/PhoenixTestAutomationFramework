...
public class CreateJobAPIWithDBValidationTest2 {
	...
	public void setup() {
		...
		customerAddress = new CustomerAddress("A 12", "Abg c", "stghj t", "erhj t", "rtghj ee", "411056", "india",
				"maharashtra");
		customerProduct = new CustomerProduct(getTimeWithDaysAgo(10), "18504753563444", "18504753563444",
				"18504753563444", getTimeWithDaysAgo(10), Product.NEXUS_2.getCode(), Model.NEXUS_2_BLUE.getCode());
